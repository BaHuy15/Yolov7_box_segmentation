...
class LoadImagesAndLabels(Dataset):
    ...
    def __init__(self,
        ...
        # print(f'this is label file: {self.label_files} and img_files {self.im_files} ')
        ...
        for i, (label, segment) in enumerate(zip(self.labels, self.segments)):
            # print(f'this is label: {label.shape} and segment {segment.shape} ')
            if include_class:
        ...
        if self.rect:
            ...
            # print('con shape ne',shapes,'image size',img_size,'stride ne ',stride,'pad ne',pad)
            stride = 32
            self.batch_shapes = np.ceil(np.array(shapes) * img_size / stride + pad).astype(np.int) * stride
            # print('batch shape ne',self.batch_shapes)
    ...
    def load_image(self, i):
        ...
        # print(f'test file path {self.im_files[i]}')
