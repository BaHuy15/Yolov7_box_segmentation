...
class LoadImagesAndLabelsAndMasks(LoadImagesAndLabels):  # for training/testing
    ...
    def __getitem__(self, index):
        ...
        if mosaic:
            ...
            # random_probalities = random.uniform(0,1)  # Generates a random float in the range [0, 1)
            ...
            #     img, labels, segments =img, labels[random_number : random_number+1], segments[random_number : random_number+1]
            ...
            #     img=bg_img
                ...
                # cv2.fillPoly(bg_img, pts=[segments.astype(np.int32)], color=(255, 0, 0))
