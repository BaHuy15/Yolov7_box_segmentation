...
from utils.segment.aug_dataloaders import create_dataloader
...
def parse_opt(known=False):
    ...
    parser.add_argument('--batch-size', type=int, default=16, help='total batch size for all GPUs, -1 for autobatch') #32
